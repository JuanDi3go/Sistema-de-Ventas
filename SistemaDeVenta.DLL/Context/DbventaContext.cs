...
namespace SistemaDeVenta.DLL.Context;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C10815CB2");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F307B4964");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483D5F8D7C1");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107E72B9575");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E99201A12");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13219032620");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F765FA49936");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D84D345D4E");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE2E790608");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A62E2A5A9D");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614A4877436");
